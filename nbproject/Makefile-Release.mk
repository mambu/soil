...
${OBJECTDIR}/src/AnsiTerm.o: src/AnsiTerm.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/AnsiTerm.o src/AnsiTerm.cpp
...
${OBJECTDIR}/src/FormatString.o: src/FormatString.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FormatString.o src/FormatString.cpp

${OBJECTDIR}/src/Log.o: src/Log.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Log.o src/Log.cpp

${OBJECTDIR}/src/LogFormat.o: src/LogFormat.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/LogFormat.o src/LogFormat.cpp
...
${OBJECTDIR}/src/MultiLogWriter.o: src/MultiLogWriter.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Iinclude -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MultiLogWriter.o src/MultiLogWriter.cpp
...
${TESTDIR}/tests/AnsiTermTest.o: tests/AnsiTermTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Wall -Iinclude -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/AnsiTermTest.o tests/AnsiTermTest.cpp
...
${OBJECTDIR}/src/AnsiTerm_nomain.o: ${OBJECTDIR}/src/AnsiTerm.o src/AnsiTerm.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/AnsiTerm_nomain.o src/AnsiTerm.cpp;\
	else  \
...
${OBJECTDIR}/src/FormatString_nomain.o: ${OBJECTDIR}/src/FormatString.o src/FormatString.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/FormatString_nomain.o src/FormatString.cpp;\
	else  \
...
${OBJECTDIR}/src/Log_nomain.o: ${OBJECTDIR}/src/Log.o src/Log.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Log_nomain.o src/Log.cpp;\
	else  \
...
${OBJECTDIR}/src/LogFormat_nomain.o: ${OBJECTDIR}/src/LogFormat.o src/LogFormat.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/LogFormat_nomain.o src/LogFormat.cpp;\
	else  \
...
${OBJECTDIR}/src/MultiLogWriter_nomain.o: ${OBJECTDIR}/src/MultiLogWriter.o src/MultiLogWriter.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Wall -Iinclude -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/MultiLogWriter_nomain.o src/MultiLogWriter.cpp;\
	else  \
